...
export default function Form() {
  const [addVideo, { data, isError, isLoading, isSuccess }] =
    useAddVideoMutation();
          ...
          <div className="grid grid-cols-6 gap-6">
            <div className="col-span-6 sm:col-span-3">
              <TextInput
                value={title}
                onChange={(e) =>
                  setAllContent((prev) => ({ ...prev, title: e.target.value }))
                }
                title="Video Title"
              />
            </div>
            ...
            <div className="col-span-6 sm:col-span-3">
              <TextInput
                value={author}
                onChange={(e) =>
                  setAllContent((prev) => ({ ...prev, author: e.target.value }))
                }
                title="Author"
              />
            </div>
            ...
            <div className="col-span-6 sm:col-span-3 lg:col-span-2">
              <TextInput
                value={views}
                onChange={(e) =>
                  setAllContent((prev) => ({ ...prev, views: e.target.value }))
                }
